...
async function list(req, res) {
  try {
    ...
    try {
      ...
      WHERE
        a.student_id = ${req.StudentId} AND d.nama_mapel = :namaMapel AND f.nama_tahun_ajaran = :tahunAjaran AND a.semester = :semester ${tanggal} AND g.nama_status_kehadiran = :statusKehadiran
      ORDER BY
      ...
      ${limit}
          ;`,
        {
          ...
          raw : true,
          replacements: {
            tahunAjaran: tahunAjaran === undefined ? "" : tahunAjaran,
            namaMapel: namaMapel === undefined ? "" : namaMapel,
            semester: semester === undefined ? "" : semester,
            statusKehadiran: statusKehadiran === undefined ? "" : statusKehadiran,
          },
        }
      );
